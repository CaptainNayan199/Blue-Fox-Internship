    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: PreferredSize(
          preferredSize:
              Size.fromHeight(90), // Specify the height of the AppBar
          child: Container(
                ...
                actions: [
                  Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                        right: 11, // Position dot to the top-right corner
                        top: 10,
                        child: Container(
                  ...
                  Stack(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        height: 33,
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(255, 255, 175,
                              55), // Use a yellowish-orange color
                          shape: BoxShape.circle,
                        ),
                        alignment: Alignment.center,
                        child: Center(
                      ...
                      Positioned(
                        top:
                            3, // Adjust positioning as needed to center over "N"
                        child: Container(
                          width:
